...
describe("SharedRedisCache Connection Resilience", () => {
  ...
  describe("Stale cache operations", () => {
    it("should set and get stale values", async () => {
    ...
    it("should maintain stale data when primary is cleared", async () => {
      await cache.set("consumer_secret:resilience-test-consumer", testValue);
  ...
  describe("Stats and server detection", () => {
    ...
    it("should detect server type", async () => {
  ...
  describe("Disconnect and reconnect behavior", () => {
    ...
    it("should fail operations after disconnect without reconnecting", async () => {
      await cache.disconnect();
  ...
  describe("Connection to invalid Redis", () => {
    it("should fail to connect to non-existent Redis", async () => {
  ...
  describe("Cache pollution prevention", () => {
    it("should reject cache entries with mismatched consumer IDs", async () => {
