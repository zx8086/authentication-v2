  ...
  describe('API Gateway Mode', () => {
    ...
    describe('constructor', () => {
      ...
      it('should handle URL with trailing slash', () => {
        const serviceWithSlash = KongServiceFactory.create('API_GATEWAY', 'http://kong:8001/', mockAdminToken);
  ...
  describe('Konnect Mode', () => {
    ...
    it('should handle Konnect-specific API calls', async () => {
      ...
      global.fetch = mock(async (url) => {
        ...
        // Mock consumer check
        if (urlStr.includes('/v2/control-planes/12345678-1234-1234-1234-123456789012/core-entities/consumers/') && !urlStr.includes('/jwt')) {
          return {
            ok: true,
            status: 200,
