...
export const executionStrategies = {
  ...
  quick: {
    ...
    commands: ["bun run k6:smoke:health", "bun run k6:smoke:tokens"],
  },
  comprehensive_smoke: {
  ...
  performance: {
    ...
    commands: ["bun run k6:smoke:health", "bun run k6:load", "bun run k6:stress"],
  },
  spike: {
    name: "Spike Testing",
    ...
    commands: ["bun run k6:smoke:health", "bun run k6:smoke:tokens", "bun run k6:spike"],
  },
};
