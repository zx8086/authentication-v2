  ...
  scenarios: {
    memory_monitoring_soak: {
      ...
      stages: [
        ...
        { duration: __ENV.K6_SOAK_WARMUP_DURATION || '2m', target: Number.parseInt(__ENV.K6_SOAK_WARMUP_VUS || '3', 10) },
        { duration: __ENV.K6_SOAK_RAMPUP_DURATION || '3m', target: Number.parseInt(__ENV.K6_SOAK_TARGET_VUS || '8', 10) },
        { duration: __ENV.K6_SOAK_PEAK_DURATION || '5m', target: Number.parseInt(__ENV.K6_SOAK_PEAK_VUS || '12', 10) },

        // Sustained load phase
        { duration: __ENV.K6_SOAK_SUSTAINED_DURATION || '10m', target: Number.parseInt(__ENV.K6_SOAK_PEAK_VUS || '12', 10) },

        // Memory pressure testing
        { duration: __ENV.K6_SOAK_PRESSURE_DURATION || '3m', target: Number.parseInt(__ENV.K6_SOAK_PRESSURE_VUS || '20', 10) },
        { duration: __ENV.K6_SOAK_PRESSURE_HOLD_DURATION || '5m', target: Number.parseInt(__ENV.K6_SOAK_PRESSURE_VUS || '20', 10) },

        // Recovery phase
        { duration: __ENV.K6_SOAK_RECOVERY_DURATION || '2m', target: Number.parseInt(__ENV.K6_SOAK_TARGET_VUS || '8', 10) },
        { duration: __ENV.K6_SOAK_STABILIZE_DURATION || '3m', target: Number.parseInt(__ENV.K6_SOAK_TARGET_VUS || '8', 10) },
...
export default function() {
  ...
  else if (Math.random() < 0.71) { // 25% of remaining 40%
  ...
  else if (Math.random() < 0.67) { // 10% of remaining 30%
