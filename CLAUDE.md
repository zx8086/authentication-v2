...
| Testing | [testing.md](docs/development/testing.md) | Complete testing guide (2931 tests, mutation testing) |
...
- Comprehensive testing (2931 tests, 100% pass rate)
...
bun run test:bun             # Unit + integration tests (2931 tests)
...
| Testing | 2931 tests (live backend + 57 chaos tests), 100% pass rate |
